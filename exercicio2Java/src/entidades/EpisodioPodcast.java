...
public class EpisodioPodcast extends Midia {
    ...
    public void reproduzir() {
        System.out.println("Reproduzindo episodio podcast:" + this.getTitulo());
    }
    ...
    //Construtor completo
    public EpisodioPodcast(String titulo, int duracao, String nome, String apresentador, String descricao) {
